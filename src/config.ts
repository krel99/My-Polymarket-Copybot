...
export const config = {
  ...
  trading: {
    ...
    // Maximum allowed price drift from the original trade price before rejecting.
    // Compares current best market price to the tracked wallet's entry price.
    // 0.05 = 5%. Set to 0 to disable.
